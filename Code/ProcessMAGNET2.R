#'========================================================================================================================================
#' Project:  sim4nexus
#' Subject:  Code to process MAGNET RESULTS using different aggregation
...
regMAGNET2sim4nexus <- read_csv("Mappings/regMAGNET2Sim4Nexus2.csv") %>%
  unique()
...
write_csv(MAGNET_tot, paste("Cache/sim4nexus2_MAGNET_", Sys.Date(), ".csv", sep=""))
